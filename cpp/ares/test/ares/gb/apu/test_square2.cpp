...
void TestRead() {
  ...
  square2.power(true);
  EXPECT_EQ("Square2 read", square2.read(0), (n8)0xff);

  square2.power(true);
  EXPECT_EQ("Square2 read", square2.read(0xff15), (n8)0b11111111);

  square2.power(true);
  square2.duty = (n2)0b01;
  EXPECT_EQ("Square2 read", square2.read(0xff16), (n8)0b01111111);

  square2.power(true);
  square2.envelopeVolume = (n4)0b1011;
  square2.envelopeDirection = true;
  square2.envelopeFrequency = (n3)0b010;
  EXPECT_EQ("Square2 read", square2.read(0xff17), (n8)0b10111010);

  square2.power(true);
  EXPECT_EQ("Square2 read", square2.read(0xff18), (n8)0b11111111);

  square2.power(true);
  square2.counter = false;
  EXPECT_EQ("Square2 read", square2.read(0xff19), (n8)0b10111111);
}
...
void TestWrite() {
  ...
  EXPECT_EQ("Square2 write", square2.duty, (n2)0b01);
  EXPECT_EQ("Square2 write", square2.length, 14u);

  square2.power(true);
  square2.enable = true;
  square2.write(0xff17, 0b10111010);
  EXPECT_EQ("Square2 write", square2.envelopeVolume, (n4)0b1011);
  EXPECT_TRUE("Square2 write", square2.envelopeDirection);
  EXPECT_EQ("Square2 write", square2.envelopeFrequency, (n3)0b010);
  EXPECT_TRUE("Square2 write", square2.enable);

  square2.power(true);
  square2.enable = true;
  square2.write(0xff17, 0);
  EXPECT_EQ("Square2 write", square2.envelopeVolume, (n4)0);
  EXPECT_FALSE("Square2 write", square2.envelopeDirection);
  EXPECT_EQ("Square2 write", square2.envelopeFrequency, (n3)0);
  EXPECT_FALSE("Square2 write", square2.enable);

  square2.power(true);
  square2.write(0xff18, 0b10110100);
  EXPECT_EQ("Square2 write", square2.frequency, (n11)0b10110100);
  ...
  EXPECT_EQ("Square2 write", square2.frequency, (n11)0b01100000000);
  EXPECT_EQ("Square2 write", square2.period, 2560u);
  EXPECT_EQ("Square2 write", square2.envelopePeriod, (n3)0);
  EXPECT_EQ("Square2 write", square2.volume, (n4)0);
  ...
  EXPECT_EQ("Square2 write", square2.period, 2560u);
  EXPECT_EQ("Square2 write", square2.envelopePeriod, (n3)0);
  EXPECT_EQ("Square2 write", square2.volume, (n4)5);
